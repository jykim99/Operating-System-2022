...
//  cprintf("roundRobinQueue inited\n");
  initQueue(&fcfsQueue);
//  cprintf("fcfsQueue inited\n");
#endif
#endif
}
...
//    cprintf("round robin length : %d\n", roundRobinQueue.length);
//    cprintf("fcfs length : %d\n", fcfsQueue.length);
...
//      cprintf("roundRobinQueue dequeue start\n");
        // cprintf("dequeue rrQueue!\n");
      procToSchedule* PTS = dequeue(&roundRobinQueue);
//      cprintf("roundRobinQueue dequeue end\n");

      if(isValidPts(*PTS)) {
//        cprintf("Valid PTS pid: %d\n", PTS->originPid);

        // next scheduling add
//        cprintf("roundRobinQueue enqueue start\n");
        enqueue(&roundRobinQueue, *PTS);
//        cprintf("roundRobinQueue enqueue end\n");
        ...
        // log
//        cprintf("MULTILEVEL_SCHED with RR, ticks = %d, pid = %d, name = %s\n", ticks, p->pid, p->name);
    ...
    //  cprintf("fcfs getNth start %d\n", i);
      procToSchedule* PTS = getNth(&fcfsQueue, i - dequedFCFS);
    //  cprintf("fcfs getNth end %d\n", i);

    //  cprintf("fetched pid : %d!!\n", PTS->originPid);

      if (isValidPts(*PTS)) {
      //  cprintf("Valid PTS pid: \n");
        p = &ptable.proc[PTS->plistIndex];

        // if(p->state != SLEEPING) {
        // // cprintf("sleeping pid %d\n", PTS->originPid);
        // }
        ...
        // log
//        cprintf("MULTILEVEL_SCHED with FCFS, ticks = %d, pid = %d, name = %s\n", ticks, p->pid, p->name);
        ...
        // cprintf("fcfsQueue dequeue %d", PTS->originPid);
        // cprintf("RR len %d", roundRobinLen);
        dequedFCFS++;
      }
    }
    release(&ptable.lock);
...
//      cprintf("UNKNOWN ticks = %d, pid = %d, name = %s\n", ticks, p->pid, p->name);
